# -*- coding: utf-8 -*-
"""modified cnn cleaned up.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Y6ec_OxSae2qS_39tIQTwMihmez8THon
...
model_path = "/content/drive/MyDrive/APS360/MODEL WEIGHTS/type2_balanced/2conv_dropout_bs512_lr0.005/first round/model_AlexNet_bs512_lr0.005_epoch44"
net = alex
...
"""**TRAINING MODEL W/ 2 CONV LAYERS AND KERNEL SIZE 2**"""
...
train(alex, train_data, val_data, batch_size = 80, learning_rate = 0.0005, num_epochs=100)
